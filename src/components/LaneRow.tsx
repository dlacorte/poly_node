...
export function LaneRow({ lane }: Props) {
  ...
  return (
    <div
      className="grid grid-cols-[52px_1fr_160px] items-center gap-2 bg-neutral-900 border border-neutral-800 rounded-lg px-2.5 py-2 hover:border-neutral-700 transition-colors"
